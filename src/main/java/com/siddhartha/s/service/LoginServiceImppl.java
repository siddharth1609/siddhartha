 ...
 * com.siddhartha.s.repository.LoginRepository; import
 * com.siddhartha.s.utils.UserMapper;
 * 
 * @Service public class LoginServiceImppl implements LoginService {
 * 
 * //@Autowired // LoginRepository loginRepository;
 * 
 * @Override public List<UserEntity> findAll() { // List<User> users = new
 * ArrayList<>(); // LoginDTO dto = new LoginDTO(); // dto = loginRepository. //
