...
public class UserController {
	...
	public ResponseEntity<String> deleteEmployeeById(@PathVariable("id") String id) throws SiddharthException {

		String deleteUserById = userService.deleteEmployeeById(id);

		return new ResponseEntity<String>(deleteUserById, new HttpHeaders(), HttpStatus.OK);
	}
